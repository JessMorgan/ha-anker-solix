...
DEVICE_SENSORS = [
    ...
    AnkerSolixSensorDescription(
        key="ac_default_input_power",
        translation_key="ac_default_input_power",
        json_key="ac_default_input_power",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="ac_30a_input_power",
        translation_key="ac_30a_input_power",
        json_key="ac_30a_input_power",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    AnkerSolixSensorDescription(
        key="ac_ev_converter_input_power",
        translation_key="ac_ev_converter_input_power",
        json_key="ac_ev_converter_input_power",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
